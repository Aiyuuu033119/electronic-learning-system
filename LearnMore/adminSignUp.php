        ...
        <div class="row">
            <div class="col l6 push-l3"><br><br><br>
                <div class="card grey darken-4 bgCard">
                    <div class="col l12">
                        <br>
                        <h6 class="center white-text fontStyle "><b>Learn<span class=" amber darken-3 black-text">more</b></span>
                        </h6><br>
                    </div>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" id="myform">
                            <div class="row">
                                <div class="input-field border-radius">
                                    ...
                                    <div class="col l6 "><br>
                                        <input type="text" name="gender" placeholder="Gender" class="center border-radius border-color white-text">
                                    </div>
                                    <div class="col l6 "><br>
                                        <input type="text" name="cn"  placeholder="Contact No." class="center border-radius border-color white-text">
                                    </div>
                    ...
                    $.ajax({
                        ...
                        success:function(info){
                            if(info==='success'){
                                ...
                                ?>
                                window.location.replace('setting.php?id=<?php echo $fetch['accID'] ?>');
                            }
                            else if(info==='fail'){
